  ...
  return (
    <main className="mx-auto max-w-[640px] px-5 pt-8 pb-16 md:pt-12 md:pb-24">
      ...
      <article className="space-y-6 font-body text-[18px] leading-[1.9] text-ink-800">
        <p>
          A sua privacidade é importante para nós. É política do Felipe Pavão respeitar
          a sua privacidade em relação a qualquer informação sua que possamos coletar
          no site <a href="https://felipepavao.com" className="text-brand-700 underline underline-offset-2">Felipe Pavão</a>,
        ...
        <p>
          ...
          Esteja ciente de que não temos controle sobre o conteúdo e práticas desses
          sites e não podemos aceitar responsabilidade por suas respectivas políticas
          de privacidade.
        </p>
        ...
        <p>
          ...
          dúvida sobre como lidamos com dados do usuário e informações pessoais, entre
          em contato conosco.
        </p>
        ...
        <h2 className="pt-6 font-body text-[36px] font-bold leading-tight text-ink-900 text-center">
          Compromisso do Usuário
        </h2>

        <p>
          O usuário se compromete a fazer uso adequado dos conteúdos e da informação
          que o Felipe Pavão oferece no site e com caráter enunciativo, mas não
          limitativo:
        </p>
        ...
        <ul className="space-y-3 pl-6 list-disc">
          ...
          <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Felipe Pavão, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
        </ul>
        ...
        <p>
          ...
          algo que você não tem certeza se precisa ou não, geralmente é mais seguro
          deixar os cookies ativados, caso interaja com um dos recursos que você usa
          em nosso site.
        </p>

        <p>Esta política é efetiva a partir de 19 June 2026 15:24.</p>
      </article>
    </main>
  )
}
